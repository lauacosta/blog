...
import { extname } from "jsr:@std/path@^1.1.4/extname";
...
import { SEPARATOR_PATTERN } from "jsr:@std/path@^1.1.4/constants";
...
import { ByteSliceStream } from "jsr:@std/streams@^1.0.17/byte-slice-stream";
import { parseArgs } from "jsr:@std/cli@^1.0.27/parse-args";
import denoConfig from "./deno.json" with { type: "json" };
import { format as formatBytes } from "jsr:@std/fmt@^1.0.9/bytes";
import { getNetworkAddress } from "jsr:@std/net@^1.0.6/unstable-get-network-address";
